        ...
        <div className="space-y-3">
          ...
          {showApplePay && (
            <button
              ...
              className={`w-full bg-black rounded-xl p-4 shadow-md transition-all flex items-center justify-between ${
            ...
            >
              ...
              <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                selectedMethod === 'applepay' ? 'border-white bg-white' : 'border-gray-400'
              }`}>
                {selectedMethod === 'applepay' && (
          ...
          {showGooglePay && (
            <button
              ...
              className={`w-full bg-white rounded-xl p-4 shadow-md transition-all flex items-center justify-between border-2 border-gray-200 ${
            ...
            >
              ...
              <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                selectedMethod === 'googlepay' ? 'border-[#390067] bg-[#390067]' : 'border-gray-300'
              }`}>
                {selectedMethod === 'googlepay' && (
          ...
          <button
            ...
            className={`w-full bg-white rounded-xl p-4 shadow-md transition-all flex items-center justify-between ${
              selectedMethod === 'card'
                ? 'ring-4 ring-[#390067] ring-opacity-50 shadow-lg'
                : 'hover:shadow-lg'
            }`}
          >
            ...
            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
              selectedMethod === 'card' ? 'border-[#390067] bg-[#390067]' : 'border-gray-300'
            }`}>
              {selectedMethod === 'card' && (
                <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          >
            ...
            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
              selectedMethod === 'lynk' ? 'border-[#390067] bg-[#390067]' : 'border-gray-300'
            }`}>
              {selectedMethod === 'lynk' && (
                <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          >
            ...
            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
              selectedMethod === 'wipay' ? 'border-[#390067] bg-[#390067]' : 'border-gray-300'
            }`}>
              {selectedMethod === 'wipay' && (
                <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          >
            ...
            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
              selectedMethod === 'cash' ? 'border-[#390067] bg-[#390067]' : 'border-gray-300'
            }`}>
              {selectedMethod === 'cash' && (
                <svg className="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
