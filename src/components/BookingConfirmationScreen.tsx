...
export default function BookingConfirmationScreen({ onBackToHome, onCompleteProfile }: BookingConfirmationScreenProps) {
      ...
      <div className="flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-12 pb-32 sm:pb-40">
        ...
        <div className="w-full space-y-2 sm:space-y-3">
          ...
          <button
            ...
            className="w-full text-gray-600 font-medium text-base py-2 hover:text-gray-900 transition-all"
            style={{ fontFamily: 'Poppins' }}
          >
            Share with Friends
          </button>
